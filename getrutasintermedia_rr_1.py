...
def generar_rutas_rr(origen, destino):
    archivo1 = "rutas_intermedias_r_repetir.txt"
    archivo2 = "rutas_intermedias_r_repetir-longitudes.txt"
...
def rutas_intermedias_x_cantidad_rr_quitando_final(origen, destino, cantidad):
...
# r = rutas_intermedias_x_cantidad_rr_quitando_final(origen, destino, 5)
# print(r)
